...
contract FundMeTest is Test {
    ...
    function testFundFailsWithouthEnoughEth() public {
        vm.expectRevert(); //The next line shloud revert
        fundMe.fund(); //send 0 value
    }

    function testFundUpdatesDataStructure() public funded {
        // vm.prank(USER); // This will make next TX from USER
    ...
    function testWithdrawFromMultipleFunders() public funded {
        ...
        for (uint160 i = startingFunderIndex; i < numberOfFunders; i++) {
            // vm.prank(USER);
            // vm.deal()
            //create a new address with some value i.e. combo of prank and deal
...
// What can we do to work with addresses outside our syster?
// 1. Unit
